...
public class DocumentProbability implements Type<DocumentProbability> {
    ...
    public interface Processor extends Step, org.galagosearch.tupleflow.Processor<DocumentProbability> {
    ...
    public static class DocumentOrder implements Order<DocumentProbability> {
        ...
        public static class ShreddedCombiner implements ReaderSource<DocumentProbability>, ShreddedSource {   
            ...
            public void setProcessor(Step processor) throws IncompatibleProcessorException {  
                if (processor instanceof ShreddedProcessor) {
                    ...
                    this.processor = new DuplicateEliminator(new TupleUnshredder((org.galagosearch.tupleflow.Processor<DocumentProbability>) processor));
                } else {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            DocumentProbability last = new DocumentProbability();
            public org.galagosearch.tupleflow.Processor<DocumentProbability> processor;                               
            
            public TupleUnshredder(DocumentProbability.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(org.galagosearch.tupleflow.Processor<DocumentProbability> processor) {
                this.processor = processor;
            }
