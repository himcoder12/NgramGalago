...
public class WordCount implements Type<WordCount> {
    ...
    public static class CountOrder implements Order<WordCount> {
        ...
        public interface ShreddedProcessor extends Step {
            ...
            public void processTuple(String word, long documents) throws IOException;
            public void close() throws IOException;
        }    
        public interface ShreddedSource extends Step {
        }                                              
        ...
        public static class ShreddedWriter implements ShreddedProcessor {
            ...
            public final void processTuple(String word, long documents) throws IOException {
                if (lastFlush) {
        ...
        public static class ShreddedBuffer {
            ...
            ArrayList<Integer> countTupleIdx = new ArrayList();
            int countReadIdx = 0;
            ...
            public void processTuple(String word, long documents) {
        ...
        public static class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<WordCount>, ShreddedSource {      
            ...
            public final void fill() throws IOException {
                try {   
                    ...
                    while (!buffer.isFull()) {
                        updateCount();
                        buffer.processTuple(input.readString(), input.readLong());
                        tupleCount++;
                    }
                } catch(EOFException e) {}
            }
