...
public class WordProbability implements Type<WordProbability> {
    ...
    public interface Processor extends Step, org.galagosearch.tupleflow.Processor<WordProbability> {
    ...
    public static class WordOrder implements Order<WordProbability> {
        ...
        public static class TupleUnshredder implements ShreddedProcessor {
            WordProbability last = new WordProbability();
            public org.galagosearch.tupleflow.Processor<WordProbability> processor;                               
            
            public TupleUnshredder(WordProbability.Processor processor) {
                this.processor = processor;
            }         
            
            public TupleUnshredder(org.galagosearch.tupleflow.Processor<WordProbability> processor) {
                this.processor = processor;
            }
